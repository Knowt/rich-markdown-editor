...
export const base = {
  ...
  blockToolbarExpandArrowColor: colors.black,
  blockToolbarIconColor: "#4E5C6E",
  blockToolbarTagBackgroundColor: "#ecf9f7",
...
export const dark = {
  ...
  blockToolbarHoverBackground: colors.black10,
  blockToolbarSelectedBackground: colors.lighterBlack,
