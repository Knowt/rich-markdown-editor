...
const isNodeActive = (type, attrs = {}) => (state) => {
    ...
    const node = prosemirror_utils_knowt_1.findSelectedNodeOfType(type)(state.selection) ||
        prosemirror_utils_knowt_1.findParentNode((node) => node.type === type)(state.selection);
