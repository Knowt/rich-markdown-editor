...
exports.dark = Object.assign(Object.assign({}, exports.base), { background: colors.almostBlack, text: colors.almostWhite, textSecondary: colors.white40, code: colors.almostWhite, cursor: colors.white, divider: "#4E5C6E", placeholder: colors.white40, blockToolbarBackground: colors.lightBlack, blockToolbarText: colors.almostWhite, blockToolbarHoverBackground: colors.black10, blockToolbarSelectedBackground: colors.lighterBlack, blockToolbarTextSelected: colors.almostWhite, blockToolbarIconColor: colors.almostWhite, blockToolbarTagBackgroundColor: colors.lighterBlack, toolbarBackground: colors.lighterBlack, toolbarHoverBackground: colors.greyMid, toolbarInput: colors.black10, toolbarItem: colors.lightBlack, tableDivider: colors.lightBlack, tableSelected: colors.primary, tableSelectedBackground: "#002333", quote: colors.greyDark, codeBackground: colors.black, codeBorder: colors.lightBlack, codeString: "#3d8fd1", horizontalRule: colors.lightBlack, imageErrorBackground: "rgba(0, 0, 0, 0.5)", scrollbarBackground: colors.black, scrollbarThumb: colors.lightBlack });
